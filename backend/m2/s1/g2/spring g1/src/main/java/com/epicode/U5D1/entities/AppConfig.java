...
public class AppConfig {
	...
	public Ordine ordine1(){
		List<Item> ordine = new ArrayList<>();
		ordine.add(pizzaHawaiianBean());
		ordine.add(pizzaSalamiBean());
		ordine.add(waterBean());
		ordine.add(lemonadeBean());
		return new Ordine(ordine,1,StatoOrdine.PRONTO,2,LocalDate.now());
